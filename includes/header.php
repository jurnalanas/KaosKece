...
<body>
	...
	<div class="header">
		...
		<!--		<li class="shirts <?php /*?><?php if ($section == "shirts") { echo "on"; } ?><?php */?>" data-original-title="titl data-content="content" rel="popover"><a href="shirts.php">Kaos</a></li>-->
				...
				<li class="contact <?php if ($section == "jual") { echo "on"; } ?>"><a href="views/jual.php">Jual Kaos</a></li>
                <li class="contact <?php if ($section == "daftarbelanja") { echo "on"; } ?>"><a href="cari.html">Search</a></li>
				<li class="cart <?php if ($section == "daftarbelanja") { echo "on"; } ?>"><a href=#">Daftar Belanja</a></li>
			</ul>
