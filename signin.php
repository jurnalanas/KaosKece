...
<script src="js/select2.min.js"></script> 
    <div class="container">
      ...
      <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" class="form-signin" name="loginForm">
        <h2 class="form-signin-heading"><center>
          <a href="#"class="hint--right  hint--always" data-hint="Beli dan Jual Kaos Jadi Lebih Seru!"><img src="views/img/kaoskece.png" alt="KaosKece" width="182" height="160" usemap="#Map">
          </a>
        </center></h2>
  ...
  <tr>
    <td width="70%"><button class="btn btn-large btn-primary" type="submit">Sign in</button></td>
    <td width="30%"><a href="register.php" class="hint--right  hint--success  hint--rounded" data-hint="Daftar akun baru disini!"><i class="icon-user"></i> Buat Akun</a></td>
  </tr>
</table>
